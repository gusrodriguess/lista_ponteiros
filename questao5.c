...
/*
    ...
    guardado naquele endereço, da mesma acontece quando é mostrado o endereço, a cada incremento
    é somado ('4 bytes' * 'o valor de i'), como podemos ver que na iteração 1, o endereço que 
    antes era 61FDF0 mudou para 61FDF4.
*/
